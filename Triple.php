...
<div class="btn-group" id="<?php echo $algo; ?>">
    <div class="thumbnail" id="<?php echo $algo; ?>_TRIPLE" ><strong>Triple <?php echo $algo;?></strong>
    	...
    	<div class="row">       
	        ...
	        <div class="col-md-10"><input class="form-control"  type="text" placeholder="?y" id="<?php echo $algo; ?> y" value="?y" onchange="cambioTexto()" onkeyup="precionarTeclay(<?php echo $algo; ?>)"list="y1"></div>
	    	</br>
